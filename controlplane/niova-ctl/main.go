...
func (m model) viewShowInitializedNISD() string {
	...
	s.WriteString(fmt.Sprintf("  NISD UUID: %s\n", m.currentNISD.ID))
	s.WriteString(fmt.Sprintf("  Device ID: %s\n", m.currentNISD.ParentID[ctlplfl.DEVICE_IDX]))
	s.WriteString(fmt.Sprintf("  Hypervisor ID: %s\n", m.currentNISD.ParentID[ctlplfl.HV_IDX]))
...
func (m model) viewNISDSelection() string {
	...
	for i, nisd := range nisdList {
		...
		info := fmt.Sprintf("UUID: %s | Device: %s | HV: %s | Ports: %d/%d",
			nisd.ID,
			nisd.ParentID[ctlplfl.DEVICE_IDX],
			nisd.ParentID[ctlplfl.HV_IDX],
			nisd.ClientPort,
			nisd.PeerPort)
...
func (m model) viewNISDStart() string {
	...
	s.WriteString(fmt.Sprintf("Device ID: %s\n", m.selectedNISDToStart.ParentID[ctlplfl.DEVICE_IDX]))
	s.WriteString(fmt.Sprintf("Hypervisor ID: %s\n", m.selectedNISDToStart.ParentID[ctlplfl.HV_IDX]))
...
func (m model) startNISDProcess() error {
	...
	fmt.Printf("  UUID: %s\n", m.selectedNISDToStart.ID)
	fmt.Printf("  Device: %s\n", m.selectedNISDToStart.ParentID[ctlplfl.DEVICE_IDX])
	fmt.Printf("  Hypervisor: %s (%s)\n", m.selectedNISDToStart.ParentID[ctlplfl.HV_IDX], m.selectedNISDToStart.IPAddr)
